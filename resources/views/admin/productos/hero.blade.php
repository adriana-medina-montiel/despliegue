...
@section('title', 'Hero — Productos')
@section('breadcrumb', 'Productos › Banner / Hero')
...
<style>
    ...
    .upload-area:hover { border-color: #ea580c; background: #fffaf5; }
...
<div class="form-page-header">
    ...
    <div class="fph-text">
        <h2>Banner / Hero</h2>
        <p>Sección de portada de la página de Productos</p>
    </div>
...
<form action="{{ route('admin.productos.hero.update') }}" method="POST" enctype="multipart/form-data">
@csrf
...
<div class="editor-layout">
        ...
        <div class="form-card" style="margin-bottom: 18px;">
            ...
            <div class="form-card-body">
                <div class="field-group">
                    ...
                    <span class="field-hint">Ej: "Productos que &lt;em&gt;impulsan&lt;/em&gt; tu organización"</span>
                    <input
                        type="text"
                        id="title"
                        name="title"
    ...
    <div>
        ...
        <div class="form-card" style="padding: 16px; text-align: center;">
            ...
            @php
                $img = $section->content('background_image');
                $src = ($img && !str_starts_with($img, 'http')) ? asset('storage/' . $img) : $img;
            @endphp
            @if($src)
                <img id="preview-bg" src="{{ $src }}" alt="Hero Background" style="width: 100%; max-height: 200px; object-fit: cover; border-radius: 8px; border: 1px solid #e2e8f0;">
            @else
                <div id="preview-bg-placeholder" style="height: 150px; background:#f1f5f9; display:flex; align-items:center; justify-content:center; border-radius:8px; color:#cbd5e1; border:1px dashed #cbd5e1;">
...
<div class="save-bar">
    <p><i class="fas fa-shield-alt" style="color:#ea580c;margin-right:5px"></i> Los cambios se aplicarán inmediatamente en el sitio.</p>
    ...
    function previewBg(event) {
        ...
        reader.onload = e => {
            ...
            if (preview) {
                ...
                const placeholder = document.getElementById('preview-bg-placeholder');
                if (placeholder) {
                    placeholder.outerHTML = `<img id="preview-bg" src="${e.target.result}" alt="Hero Background" style="width: 100%; max-height: 200px; object-fit: cover; border-radius: 8px; border: 1px solid #e2e8f0;">`;
                }
            }
        };
