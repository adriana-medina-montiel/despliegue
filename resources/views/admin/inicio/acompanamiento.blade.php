...
@section('title', 'Acompañamiento — Inicio')
@section('breadcrumb', 'Página principal › Acompañamiento')

@section('content')
@include('admin.inicio.partials.form-styles', ['accent' => '#0f172a'])

<div class="form-page-header">
    <div class="fph-icon"><i class="fas fa-hands-helping"></i></div>
    <div class="fph-text"><h2>Sección Acompañamiento</h2><p>Aliado tecnológico, párrafos e imagen</p></div>
...
<form action="{{ route('admin.inicio.acompanamiento.update') }}" method="POST" enctype="multipart/form-data">
@csrf
    ...
    <div>
        <div class="form-card">
            ...
            <div class="form-card-body">
                ...
                <div class="field-group"><label class="field-label">Párrafo 1</label><span class="field-hint">Admite HTML (&lt;strong&gt;, etc.)</span><textarea name="paragraph_1" class="field-input">{{ old('paragraph_1', $section->content('paragraph_1')) }}</textarea></div>
                <div class="field-group"><label class="field-label">Párrafo 2</label><textarea name="paragraph_2" class="field-input">{{ old('paragraph_2', $section->content('paragraph_2')) }}</textarea></div>
            </div>
        </div>
        <div class="form-card">
