...
@section('title', 'Contacto — Inicio')
@section('breadcrumb', 'Página principal › Llamada a la acción')
...
<div class="form-page-header">
    ...
    <div class="fph-text">
        <h2>Llamada a la Acción & Contacto</h2>
...
<form action="{{ route('admin.inicio.cta.update') }}" method="POST">
@csrf
        ...
        <div class="form-card">
            ...
            <div class="form-card-body">
                ...
                <div class="field-group">
                    ...
                    <span class="field-hint">Puedes incluir &lt;span&gt;...&lt;/span&gt; o saltos de línea &lt;br&gt;.</span>
